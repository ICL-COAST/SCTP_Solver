...
try
    data = readdlm(string(vern8_rel_tol)*"_"*string(orbital_period_multiplier)*"_test_case_3_benchmark.txt")
    ...
    writedlm(string(vern8_rel_tol)*"_"*string(orbital_period_multiplier)*"_test_case_3_benchmark.txt", data, ' ')
end
