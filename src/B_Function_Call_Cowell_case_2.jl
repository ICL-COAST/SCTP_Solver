...
try
    data = readdlm(string(vern8_rel_tol)*"_"*string(orbital_period_multiplier)*"_test_case_2_benchmark.txt")
    ...
    writedlm(string(vern8_rel_tol)*"_"*string(orbital_period_multiplier)*"_test_case_2_benchmark.txt", data, ' ')
end
...
global m_order_IVP         =       60                            # [-] - MCPI order of the polynomial approximation
global m_interval_IVP      =       time_span_IVP[2]/70               # [seconds, multiples of solar days] - the MCPI interval
...
global s_order_IVP         =      50                             # [-] - MCPI order of the polynomial approximation
...
gcn_it_tol    =       1e-10                           # [-] - relative tolerance of the spectral integrator
...
println("Case 2 Calculations Complete")


#DOPRI 853
println("Running DOPRI853 for case 2")
global dop_rel_tol             =       1e-12                           # [-] - relative tolerance of the DOPRI853 integrator
...
#RK45 with TSIT
println("Running RK45 for case 2")
global rk45_rel_tol             =       1e-12                           # [-] - relative tolerance of the DOPRI853 integrator
global rk45_abs_tol             =       1e-12                           # [ER] - absolute tolerance of the DOPRI853 integrator
global function_calls = 0
...
println("Post Processing Case 2 Spectral results")
...
PyPlot.title("Plot of Error for case 2, orbits:"*string(orbital_period_multiplier))
PyPlot.legend()
